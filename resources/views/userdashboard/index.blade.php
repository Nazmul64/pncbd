...
<head>
    ...
    <title>ড্যাশবোর্ড - {{ $gs->site_name ?? 'Pncbd' }}</title>
...
<body>
    @include('userdashboard.partials.customer-navbar', ['activeRoute' => 'dashboard'])
    ...
    <div class="container">
        ...
        <div class="hero-banner">
            <div class="hero-content">
                <h1 class="hero-title">স্বাগতম, {{ auth()->user()->information->full_name ?? $user->name }}!</h1>
                <p class="hero-subtitle">আপনার অ্যাকাউন্টে ব্যবসায়িক স্বাগতম</p>
            </div>
            <div class="hero-avatar" style="overflow:hidden; display:flex; align-items:center; justify-content:center;">
                @if(auth()->user()->information && auth()->user()->information->selfie)
                    <img src="{{ asset(auth()->user()->information->selfie) }}" style="width:100%; height:100%; object-fit:cover;">
                @else
                ...
                <div class="stat-info">
                    ...
                    <div class="stat-text">
                        @if($loans->isEmpty())
                            কোনো ঋণ নেই
                        @else
                            @php $latestLoan = $loans->first(); @endphp
                            @if($latestLoan->status === 'pending')
                                <span class="stat-warning"><i class="fas fa-hourglass-half me-1"></i> অপেক্ষমান</span>
                            @elseif($latestLoan->status === 'approved')
                                <span class="text-success"><i class="fas fa-check-circle me-1"></i> অনুমোদিত</span>
                            @else
                                <span class="text-danger"><i class="fas fa-times-circle me-1"></i> প্রত্যাখ্যাত</span>
                            @endif
                        @endif
                    </div>
                </div>
            ...
            <div class="stat-card">
                ...
                <div class="stat-info">
                    ...
                    @if(auth()->user()->information)
                        <span class="text-success fw-bold"><i class="fas fa-check-circle me-1"></i> সম্পূর্ণ</span>
                    @else
        ...
        <div class="quick-actions">
            <a href="/loan/apply/step1" class="action-card blue">
            ...
            <a href="{{ route('customer.profile.index') }}" class="action-card purple">
                <div class="action-icon">
            ...
            <a href="{{ route('customer.card') }}" class="action-card orange">
                <div class="action-icon">
        ...
        @if($loans->isNotEmpty())
            <div class="withdraw-section">
                <div class="section-header mb-4">
                    ...
                    <h2 class="section-heading">ঋণ আবেদনসমূহের তালিকা</h2>
                </div>
                    ...
                    <table class="table table-hover align-middle">
                        <thead class="table-light">
                            <tr>
                                ...
                                <th>মোবাইল/ব্যাংক অ্যাকাউন্ট</th>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        @if($loan->payment_method === 'bikash')
                                            <span class="badge bg-danger">বিকাশ</span>
                                        @elseif($loan->payment_method === 'nagad')
                                            <span class="badge bg-warning text-dark">নগদ</span>
                                        @else
                                            <span class="badge bg-primary">ব্যাংক</span>
                                        @endif
                                    </td>
                                    <td>
        ...
        @else
            ...
            <div class="no-loan-section">
                ...
                <a href="/loan/apply/step1" class="new-loan-btn">
