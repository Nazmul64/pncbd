...
<head>
  ...
  <title>নিবন্ধন - {{ $gs->site_name ?? 'Pncbd' }}</title>
  ...
  <style>
    ...
    * { box-sizing: border-box; }
    ...
    .welcome-title { font-size: 1.55rem; font-weight: 700; color: var(--primary); margin-bottom: .2rem; }
...
<div class="login-wrapper">
  ...
  <div class="left-panel">
    <div class="form-inner">
      ...
      <div class="text-center mb-4">
        <p class="welcome-title mb-1">নতুন অ্যাকাউন্ট</p>
        <p class="welcome-sub mb-0">রেজিস্ট্রেশন করে শুরু করুন</p>
      </div>
      ...
      <form method="POST" action="{{ route('customer.register.submit') }}" novalidate>
        ...
        <div class="mb-3">
          <div class="field-label">পুরো নাম (ইংরেজিতে)</div>
          <div class="custom-input-group">
            <span class="input-icon"><i class="bi bi-person"></i></span>
            <input type="text" name="name" placeholder="Your Full Name" value="{{ old('name') }}" required autocomplete="name">
          </div>
        </div>
        ...
        <div class="mb-3">
          ...
          <div class="custom-input-group">
            ...
            <input type="tel" name="phone" placeholder="01XXXXXXXXX" value="{{ old('phone') }}" maxlength="11" required autocomplete="tel">
          </div>
          <div class="hint-text"><i class="bi bi-info-circle"></i> ১১ ডিজিটের মোবাইল নম্বর</div>
        </div>
        ...
        <div class="mb-3">
          ...
          <div class="custom-input-group">
            ...
            <button type="button" class="eye-btn" onclick="toggleEye('pass','ei1')" aria-label="পাসওয়ার্ড দেখুন">
              <i class="bi bi-eye" id="ei1"></i>
            </button>
          </div>
          <div class="hint-text"><i class="bi bi-info-circle"></i> কমপক্ষে ৮ অক্ষর</div>
        </div>

        <div class="mb-4">
          <div class="field-label">পাসওয়ার্ড নিশ্চিত করুন</div>
          <div class="custom-input-group">
            <span class="input-icon"><i class="bi bi-lock-fill"></i></span>
            <input type="password" name="password_confirmation" id="passConfirm" placeholder="••••••••" required>
            <button type="button" class="eye-btn" onclick="toggleEye('passConfirm','ei2')" aria-label="পাসওয়ার্ড দেখুন">
      ...
      <div class="text-center d-flex flex-column align-items-center gap-2">
        <p class="footer-link mb-0">
          ইতিমধ্যে অ্যাকাউন্ট আছে? <a href="{{ route('customer.login') }}">লগইন করুন</a>
        </p>
  ...
  <div class="right-panel">
    ...
    <div class="right-content">
      <p class="right-heading">আপনার স্বপ্নের লোন,<br>এক ক্লিকে শুরু!</p>
      <p class="right-sub">দ্রুত ও নিরাপদ রেজিস্ট্রেশন</p>
