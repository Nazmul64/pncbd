                ...
                <form action="{{ route('admin.Generalsettings.update', $setting->id) }}" method="POST">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="number" name="product_img_height_mobile" class="form-control" value="{{ $setting->product_img_height_mobile }}" min="10" max="800">
                            <small class="text-muted">Proportional height for mobile grid. Can be set to 50, 100, etc. Default: 160px</small>
                        </div>
                        <div class="col-md-6">
