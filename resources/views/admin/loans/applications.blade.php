    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        <div>
            <h1 class="h3 mb-1 text-gray-800 fw-bold">
                <i class="bi bi-file-earmark-text me-2 text-warning"></i>লোন আবেদনসমূহ
            </h1>
            <p class="text-muted mb-0">অপেক্ষমান সকল ঋণ আবেদন — পর্যালোচনা ও সিদ্ধান্ত নিন</p>
        </div>
        ...
        <div class="col-md-4">
            <div class="card border-0 shadow-sm rounded-4 p-3 bg-white border-start border-warning border-5">
                <div class="d-flex align-items-center">
                    ...
                    <div>
                        <h6 class="text-muted mb-1 text-uppercase fw-bold" style="font-size: 0.75rem; letter-spacing: 0.5px;">মোট অপেক্ষমান</h6>
        ...
        <div class="col-md-4">
            <div class="card border-0 shadow-sm rounded-4 p-3 bg-white border-start border-primary border-5">
                <div class="d-flex align-items-center">
                    ...
                    <div>
                        <h6 class="text-muted mb-1 text-uppercase fw-bold" style="font-size: 0.75rem; letter-spacing: 0.5px;">মোট চাহিদা</h6>
                        <h4 class="mb-0 fw-bold text-dark">৳{{ number_format(\App\Models\Loan::where('status', 'pending')->sum('amount'), 0) }}</h4>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="card border-0 shadow-sm rounded-4">
        ...
        <div class="card-header bg-white border-0 pt-4 pb-0 px-4">
            <div class="d-flex flex-column flex-md-row justify-content-between align-items-md-center gap-3 pb-3 border-bottom">
                ...
                <form action="{{ route('admin.loan-applications') }}" method="GET" class="d-flex gap-2" style="max-width: 400px; width: 100%;">
                    ...
                    @if(request()->filled('search'))
                        <a href="{{ route('admin.loan-applications') }}" class="btn btn-outline-secondary rounded-pill py-2 px-3">রিসেট</a>
                    @endif
                </form>
            </div>
        </div>
        ...
        <div class="card-body p-0">
                    ...
                    <table class="table table-hover align-middle mb-0" style="min-width: 900px;">
                        <thead class="table-light border-bottom-0">
                            <tr>
                                ...
                                <th class="py-3" style="font-size: 0.8rem; font-weight: 700; color: #475569; text-transform: uppercase;">আবেদনের তারিখ</th>
                        ...
                        <tbody>
                            @foreach($loans as $loan)
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <div class="rounded-circle bg-warning bg-opacity-10 text-warning d-flex align-items-center justify-content-center fw-bold me-3"
            ...
            @else
                <div class="text-center py-5">
                    <div class="text-warning mb-3"><i class="bi bi-hourglass fs-1"></i></div>
                    <h5 class="fw-bold text-dark">কোনো অপেক্ষমান আবেদন নেই</h5>
                    <p class="text-muted small">এই মুহূর্তে কোনো নতুন আবেদন পর্যালোচনার অপেক্ষায় নেই।</p>
                </div>
            @endif
        </div>
    </div>
