                                    ...
                                    <td class="pe-4 text-end">
                                        @if($loan->screenshot)
                                            <button type="button" class="btn btn-sm btn-outline-success rounded-pill px-3 fw-bold me-2" onclick="showScreenshotModal('{{ asset($loan->screenshot) }}', '{{ $loan->id }}')">
                                                <i class="fa-solid fa-image me-1"></i> স্ক্রিনশট
                                            </button>
                                        @endif
    ...
    <div class="modal-dialog modal-dialog-centered modal-lg">
        <div class="modal-content" style="border-radius: 16px; overflow: hidden; border: none; box-shadow: 0 10px 30px rgba(0,0,0,0.15);">
            <div class="modal-header bg-dark text-white border-0 py-3">
                <h5 class="modal-title fw-bold" id="adminScreenshotModalLabel"><i class="fa-solid fa-receipt me-2 text-success"></i>পেমেন্ট স্লিপ স্ক্রিনশট</h5>
...
<script>
    function showScreenshotModal(url, loanId) {
        ...
        document.getElementById('adminScreenshotModalLabel').innerHTML = '<i class="fa-solid fa-receipt me-2 text-success"></i>পেমেন্ট স্লিপ স্ক্রিনশট (আবেদন #' + loanId + ')';
