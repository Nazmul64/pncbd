...
<style>
    ...
    .usr-select:focus { border-color: #3b82f6; background: #fff; box-shadow: 0 0 0 4px rgba(59, 130, 246, 0.1); }
...
<div class="ap-page">
    <div class="ap-page-header">
        ...
        <div>
            <h2 class="ap-h2">সরাসরি পারমিশন দিন</h2>
            <p class="ap-sub">ইউজার সিলেক্ট করে তাকে সরাসরি পারমিশন (Direct Permissions) প্রদান করুন</p>
        </div>
    </div>
