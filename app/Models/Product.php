...
class Product extends Model
{
    ...
    /**
     * Get sorted list of special categories (A-Z)
     */
    public static function getSpecialCategories(): array
    {
        $list = [
            'Panjabi', 'শাড়ি', 'থ্রি-পিস', 'কাপল ড্রেস', 'Shirt', 'T-Shirt', 'বোরকা', 
            'বুটিকস থ্রি পিস', 'কুর্তি & গাউন', 'টু পিস', 'বাচ্চাদের জামা', 'Innerwear', 
            'বেডশিট', 'লেডিস টিশার্ট', 'চশমা', 'ঘড়ি', 'ল্যাপটপ', 'মোবাইল', 'ফার্নিচার', 
            'মেয়েদের জিন্স', 'প্যান্ট', 'জুতা', 'ব্যাগ', 'Digital Products', 
            'Health & Personal Care', 'Sports & Fitness', 'Grocery & Food', 
            'Kitchen & Dining', 'Home Decor', 'Home & Furniture', 'Electronics', 
            'Cosmetics & Beauty', 'Jewelry & Accessories', 'Fashion & Clothing', 
            'Shoes & Footwear', 'Bags & Travel', 'Books & Stationery', 
            'Toys & Baby Products', 'Automotive', 'Pet Products', 'Service Categories'
        ];
        sort($list);
        return $list;
    }
    ...
    // ── Custom Special Categories JSON Accessor/Mutator ────────────────
    public function getSpecialCategoriesAttribute($value)
    {
        return $value ? json_decode($value, true) : [];
    }

    public function setSpecialCategoriesAttribute($value)
    {
        $this->attributes['special_categories'] = $value ? json_encode($value, JSON_UNESCAPED_UNICODE) : null;
    }
}
